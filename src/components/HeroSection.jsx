  ...
  return (
    (<div
      ...
      <div className="max-w-6xl mx-auto p-4">
        <h1
          className="relative z-10 text-3xl md:text-8xl  bg-clip-text text-transparent bg-gradient-to-b from-[#fffcdc] to-[#14281D] text-center font-sans font-bold">
          Grow Your <br />
          Business Online with Us!
        </h1>
        <p></p>
        <p
          className="text-[#fffcdc]/90 max-w-2xl mx-auto my-4 text-lg text-center relative z-10">
