...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#14281D] text-[#fffcdc]  py-4 md:py-10 px-5 md:px-24">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        
        {/* Logo */}
        <div className="flex flex-col items-center md:items-start">
          <img src="./devpoint-logo-removebg.png" alt="Company Logo" className="h-14" />
          <p className="text-[#fffcdc]/70 text-sm mt-2">Empowering your business with technology.</p>
        </div>
        ...
        <div className="text-center md:text-left">
          ...
          <p className="flex items-center gap-2 mt-2">
            <FaPhoneAlt className="text-[#fffcdc]" /> +91 707 823 1741
          </p>
          <p className="flex items-center gap-2 mt-2">
            <FaEnvelope className="text-[#fffcdc]" /> devpoint908@gmail.com
          </p>
        </div>
      ...
      <div className="text-center mt-10 border-t border-gray-700 pt-5">
        <p className="text-lg text-[#fffcdc]">
